        ...
        {rooms.map((room) => (
          <li key={room.id} role="listitem">
            <button
              ...
              className="nav-card-interactive flex w-full items-center gap-3 border-b border-yapo-blue/10 px-4 py-3 text-left hover:border-yapo-cta/30 hover:bg-yapo-cta/5"
            >
