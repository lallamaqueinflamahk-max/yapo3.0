...
import { createVideoService, type Participant } from "@/lib/video";
...
/**
 * Sala de videollamada multiusuario.
 * WebRTC + señalización vía WebSocket (NEXT_PUBLIC_WS_URL).
 * Logs de eventos WS en consola. UI mobile-first.
 */
